...
options = {
    ...
    series: [{
        name: "Inflation",
        data: [2.3, 3.1, 4, 10.1, 4, 3.6, 3.2]
    }],
    xaxis: {
        categories: ["PAYSWITCH", "DREAMOVAL", "MTNGHANA", "VODAFONEGHANA", "AIRTELGHANA", "ZENITHBANKGHANA", "ETRANZACT"],
        position: "top",
        labels: {
            offsetY: 7
        },
    ...
    title: {
        text: "AI Queries Unaithorized OVA grouped by route",
        floating: !0,
        offsetY: 350,
        align: "center",
        style: {
