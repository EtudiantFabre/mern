...
! function(i, e) {
    "use strict";
    var c = ["#727cf5", "#0acf97", "#6c757d", "#fa5c7c", "#ffbc00", "#39afd1", "#e3eaef", "#e3eaef"];
    e.createBarChart = function(e, t) {
        ...
        u.isAnimated(!0).width(r).height(d).margin({
            ...
            bottom: 20,
            right: 10
        }).betweenBarsPadding(.5).colorSchema(l).on("customMouseOver", n.show).on("customMouseMove", n.update).on("customMouseOut", n.hide), o.datum(t).call(u), d3.select(e + " .metadata-group").datum([]).call(n)
        ...
        u.width(250).height(200).colorSchema(l).numberFormat("s"), n.height(300).highlightSliceById(3).colorSchema(l).hasFixedHighlightedSlice(!0).internalRadius(80).on("customMouseOver", function(e) {
