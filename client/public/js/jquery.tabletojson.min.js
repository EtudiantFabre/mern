! function(a) {
    ...
    var b = function(b, c, d) {
        this.$element = a(b), this.index = c, this.cachedRowSpan = null, this.options = a.extend({}, a.fn.tableToJSONCell.defaults, d), this.init()
    };
    b.prototype = {
        constructor: b,
        value: function(b) {
...
function(a) {
    "use strict";
    var b = function(b, c) {
        this.$element = a(b), this.cells = [], this.options = a.extend({}, a.fn.tableToJSONRow.defaults, c), this.init()
    };
    b.prototype = {
        constructor: b,
        id: function() {
        ...
        valuesWithHeadings: function(a) {
            for (var b = {}, c = this.values(), d = 0; d < c.length; d++) b[a[d]] = c[d];
            return b
        },
        isEmpty: function() {
            for (var a = !0, b = this.values(), c = 0; a && c < b.length; c++) "" !== b[c] && (a = !1);
            return a
        },
        cell: function(a) {
...
function(a) {
    "use strict";
    var b = function(b, c) {
        this.$element = a(b), this.rows = [], this.options = a.extend({}, a.fn.tableToJSON.defaults, c), this.init()
    };
    b.prototype = {
        constructor: b,
        headings: function() {
